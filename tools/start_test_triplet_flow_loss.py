...
from utils import test_triplet_flow_loss
import _init_paths
...
def parse_args():
    ...
    parser.add_argument('--weights', dest='model', help='pretrained model', default=None, type=str)
...
if __name__ == '__main__':
    ...
    test_triplet_flow_loss.test_loss(network, roidb,
